...
from tigerclaw.cli import commands
...
def mock_prompt_session():
    ...
    with patch("tigerclaw.cli.commands._PROMPT_SESSION", mock_session), \
         patch("tigerclaw.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("tigerclaw.cli.commands.PromptSession") as MockSession, \
         patch("tigerclaw.cli.commands.FileHistory") as MockHistory, \
