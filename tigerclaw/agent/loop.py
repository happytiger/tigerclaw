...
from tigerclaw.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
...
from tigerclaw.agent.tools.web import WebFetchTool, WebSearchTool
from tigerclaw.bus.events import InboundMessage, OutboundMessage
from tigerclaw.bus.queue import MessageBus
from tigerclaw.providers.base import LLMProvider
from tigerclaw.session.manager import Session, SessionManager

if TYPE_CHECKING:
    from tigerclaw.config.schema import ChannelsConfig, ExecToolConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        from tigerclaw.config.schema import ExecToolConfig
        self.bus = bus
    ...
    async def _connect_mcp(self) -> None:
        ...
        from tigerclaw.agent.tools.mcp import connect_mcp_servers
        try:
