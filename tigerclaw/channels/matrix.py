...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install tigerclaw-ai[matrix]"
    ) from e

from tigerclaw.bus.events import OutboundMessage
from tigerclaw.channels.base import BaseChannel
from tigerclaw.config.paths import get_data_dir, get_media_dir
from tigerclaw.utils.helpers import safe_filename
