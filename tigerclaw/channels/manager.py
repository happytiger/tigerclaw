...
class ChannelManager:
    ...
    def _init_channels(self) -> None:
        ...
        if self.config.channels.telegram.enabled:
            try:
                from tigerclaw.channels.telegram import TelegramChannel
        ...
        if self.config.channels.mochat.enabled:
            try:
                from tigerclaw.channels.mochat import MochatChannel
        ...
        if self.config.channels.slack.enabled:
            try:
                from tigerclaw.channels.slack import SlackChannel
        ...
        if self.config.channels.matrix.enabled:
            try:
                from tigerclaw.channels.matrix import MatrixChannel
